...
public class AccessibilityNodeInfoRef {
     ...
     */
    private static AccessibilityNodeInfoRef owned(
            AccessibilityNodeInfoCompat node) {
    ...
    boolean lastChild() {
        ...
        ReorderedChildrenIterator iterator =
                ReorderedChildrenIterator.createDescendingIterator(mNode);
        try {
    ...
    boolean previousSibling() {
        ...
        ReorderedChildrenIterator iterator =
                ReorderedChildrenIterator.createDescendingIterator(parent);
        try {
    ...
    boolean nextSibling() {
        ...
        ReorderedChildrenIterator iterator =
                ReorderedChildrenIterator.createAscendingIterator(parent);
        try {
            if (!moveIteratorAfterNode(iterator, mNode)) {
                return false;
            }
    ...
    private boolean moveIteratorAfterNode(Iterator<AccessibilityNodeInfoCompat> iterator,
                                          AccessibilityNodeInfoCompat node) {
        if (node == null) {
            return false;
        }
