...
public class DirectionalTraversalStrategy implements TraversalStrategy {
    ...
    private boolean processNodes(AccessibilityNodeInfoCompat root, boolean forceRefresh) {
        ...
        boolean isFocusable = AccessibilityNodeInfoUtils.shouldFocusNode(rootNode,
                mSpeakingNodesCache);
        if (isFocusable) {
    ...
    public AccessibilityNodeInfoCompat findFocus(AccessibilityNodeInfoCompat focused,
