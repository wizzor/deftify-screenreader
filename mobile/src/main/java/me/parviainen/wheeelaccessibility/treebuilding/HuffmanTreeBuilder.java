...
import me.parviainen.wheeelaccessibility.ProbabilityModelReader;
...
import me.parviainen.wheeelaccessibility.treebuilding.TreeBuilder;
import me.parviainen.wheeelaccessibility.treebuilding.TreeBuilderUtils;
 ...
 * TODO This builder needs to be made available to users. It is currently dead code.
 */
public class HuffmanTreeBuilder extends TreeBuilder {
    ...
    public HuffmanTreeBuilder(Context context, int degree,
                              ProbabilityModelReader probabilityModelReader)
    ...
    private PriorityQueue<HuffmanNode> getOptionScanNodeProbabilities(String userContext,
        ...
        for(SwitchAccessNodeCompat currentNode : talkBackOrderSet) {
            ...
            List<AccessibilityNodeActionNode> currentNodeActions =
    ...
    @Override
    public OptionScanNode addViewHierarchyToTree(SwitchAccessNodeCompat node, OptionScanNode treeToBuildOn) {
        return null;
    }

    @Override
    public OptionScanNode addWindowListToTree(List<SwitchAccessWindowInfo> windowList, OptionScanNode treeToBuildOn) {
        return null;
    }
